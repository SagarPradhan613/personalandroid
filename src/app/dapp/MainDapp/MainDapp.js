                                    ...
                                    <div className='flex justify-between'>
                                        ...
                                        <div className='stage-path  flex flex-col justify-center items-center'>
                                            ...
                                            <div className='flex mt-8 items-center' onClick={() => { handleClick1() }}>
                                                <div className={`${road >= 1 ? 'border-[#476FFF]' : "border-[#476FFF4D]"} ${road > 1 ? 'bg-[#476FFF]' : 'bg-[#041736]'} border-[2px]  transition-all duration-1000 rounded-[50%] h-[13px] w-[13px]`}>
                                            ...
                                            {/* stage 2 */}
                                            <div className='flex  items-center' onClick={() => { handleClick2() }}>
                                                <div className={`${road >= 2 ? 'border-[#476FFF]' : "border-[#476FFF4D]"} ${road > 2 ? 'bg-[#476FFF]' : 'bg-[#041736]'} border-[2px]  transition-all duration-1000 rounded-[50%] h-[13px] w-[13px]`}>
                                            ...
                                            {/* stage 23*/}
                                            <div className='flex  items-center' onClick={() => { handleClick3() }}>
                                                <div className={`${road >= 3 ? 'border-[#476FFF]' : "border-[#476FFF4D]"} ${road > 3 ? 'bg-[#476FFF]' : 'bg-[#041736]'} border-[2px]  transition-all duration-1000 rounded-[50%] h-[13px] w-[13px]`}>
                                            ...
                                            {/* stage 4*/}
                                            <div className='flex  items-center' onClick={() => { handleClick4() }}>
                                                <div className={`${road >= 4 ? 'border-[#476FFF]' : "border-[#476FFF4D]"} ${road >= 4 ? 'bg-[#476FFF]' : 'bg-[#041736]'} border-[2px]  transition-all duration-1000 rounded-[50%] h-[13px] w-[13px]`}>
