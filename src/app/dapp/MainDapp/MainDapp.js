...
const MainDapp = () => {
   ...
   const handleClick1 = () => {
    ...
    return (
        <>
            <div className='lg:flex hidden  h-[85vh] responsive-main-height relative pt-20 w-full gap-6'>
                ...
                <div className='w-[10%] main1'>

                </div>
                <div className='w-[80%] main2'>
                    <p className='font-normal text-3xl -mt-4 text-white ml-36'>Token Deployer</p>
